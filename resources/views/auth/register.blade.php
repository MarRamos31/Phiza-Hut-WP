            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="inputAddress" class="col-md-4 col-form-label text-md-right">Phone Number</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row" >
                                ...
                                <label for="inputAddress2" class="col-md-4 col-form-label text-md-right">Adress</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="adress" placeholder="Jl." name="address">
                            </div>
                        </div>
